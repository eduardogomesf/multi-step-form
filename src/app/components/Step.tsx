  ...
  return (
    <div className="flex flex-row items-center justify-start gap-6">
      ...
      <div className="hidden sm:flex sm:flex-col sm:gap-2">
        <span className="text-xs text-light-blue font-normal leading-3">STEP {step.number}</span>
        <strong className="text-sm text-white font-bold leading-3 uppercase tracking-[1px]">{step.title}</strong>
      </div>
    </div>
  )
} 